...
data$action_owner_division <- dplyr::case_when(
  is.na(data$ownership_bucket) | data$ownership_bucket == "1. Control - Division" ~ data$division,
  data$ownership_bucket == "2. Control - With support" | data$ownership_bucket == "3. Outside control" ~ data$support_function,
